...
const Gallery = () => {
  const images = [
    ...
    "https://images.unsplash.com/photo-1530026405186-ed1f139313f8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2087&q=80",
    "https://images.unsplash.com/photo-1624727828489-a1e03b79bba8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80",
    ...
    "https://images.unsplash.com/photo-1628595351029-c2bf17511435?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2072&q=80",
  ];
    ...
    <section id="gallery" className="section gallery">
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <Swiper
          ...
          effect="fade"
          loop={true}
          className="gallery-swiper rounded-2xl overflow-hidden shadow-lg"
        >
          {images.map((image, index) => (
            <SwiperSlide key={index}>
              <div className="gallery-image-container rounded-2xl overflow-hidden">
                <img
                  src={image}
